...
# density cutoff
rho_cut=.01 #0.12 
# particle contribution cutoff
eta_cut=.000014 #0.000002 .000005

# Location of stl and xyz files
stl_path='/work/07329/joshg/stampede2/simulations/ParticleModel/intermediate/time_'"$timenum"'/'
mkdir "$stl_path"
...
for ((num=0;num<NUMTIME;num++)); do
  ...
  timestep=${time_array[num]} #time_array
  ...
  folder_name='/work/07329/joshg/stampede2/simulations/ParticleModel/results_mod/particle_FULLset4_'"$timestep"'_newbed'                                                                  # PATH TO FOLDER WHERE STEP FILES WILL BE SAVED
  ...
  do
    /work/07329/joshg/stampede2/Meshlab/meshlab/distrib/meshlabserver -i ${xyz_names[numo]} -o ${stl_names[numo]} -s /work/07329/joshg/stampede2/simulations/ParticleModel/mewtwo_script_mod.mlx      # PATH TO PYTHON SCRIPTS
  done
  ...
  # run workbench scripts to solve for thermal conductivity
  #cd /scratch/07329/joshg/ansys/
  #rm -r .temp_files.backup
  ...
  python /work/07329/joshg/stampede2/simulations/ParticleModel/sphere.py $part_number $timestep $mult_large
  python /work/07329/joshg/stampede2/simulations/ParticleModel/small_sphere.py $part_number $timestep $mult_small
  python /work/07329/joshg/stampede2/simulations/ParticleModel/hollow_sphere.py $part_number $timestep
  python /work/07329/joshg/stampede2/simulations/ParticleModel/bubble_hollow.py $part_number $timestep
  ...
  touch '/work/07329/joshg/stampede2/simulations/ParticleModel/results_mod/particle_FULLset4_'"$timestep"'_newbed/timestep.txt'
  echo $timestep >> '/work/07329/joshg/stampede2/simulations/ParticleModel/results_mod/particle_FULLset4_'"$timestep"'_newbed/timestep.txt'  

  #ansys_fol='/work/07329/joshg/stampede2/simulations/ParticleModel/results_mod/particle_FULLset4_'"$timestep"'_newbed/nanoparticle_workbench_final.wbjn'
  #./runwb2 -B -R "$ansys_fol"  #/work/07329/joshg/stampede2/simulations/ParticleModel/ansys_scripts/nanoparticle_workbench_FullMesh.wbjn   # need a way to pass variables into these scripts
