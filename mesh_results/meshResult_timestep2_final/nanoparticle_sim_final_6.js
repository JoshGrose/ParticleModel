...
ListView.ItemValue = "1.0E-7";  // line 288
...
//ListView.ItemValue = "4.0E-7"; //6.0E-7 for both //300
...
var lGroupDefaults = ListView.FindGroup(7);
lGroupDefaults.Expand = 1;
ListView.ActivateItem("Nodes");
ListView.SelectedItem.IsChecked="true";
ListView.ActivateItem("Elements");
ListView.SelectedItem.IsChecked="true"; // 311
...
//lGroupDefaults.Expand = 1; //Expand group
//ListView.ActivateItem("Scoping Method"); //line 317
...
ListView.ItemValue = "8E-6" //7.0E-6
DS.SelectionManager.Clear();
