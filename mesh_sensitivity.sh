...
mesh_array_1=("2.28E-6")  #("15.8E-6"  "10.5E-6"  "7E-6") # "4.7E-6" "3.1E-6" "2.58") # currently "index 4.5"
mesh_array_2=("1.33E-6")  #("9E-6" "6E-6" "4E-6" ) #"2.7E-6" "1.8E-6" "1.5") # currently "index 4.5"
mesh_array_3=(0 0)
...
index_array=(2) #(1 2 3) # need to be swapped for higher numbers on next run to prevent overwriting of results files
